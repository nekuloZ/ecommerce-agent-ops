...
> 多Agent协作的骨架：十二部制 + 前台分拣 + 实时看板 + 完整工作流。

- [x] 十二部制 Agent 架构（前台 + 中书·门下·尚书 + 户礼兵刑工 + 人力资源 + 晨会官）
- [x] 前台分拣层 —— 自动识别闲聊/指令，闲聊直接回复，指令提炼标题后转产品经理
...
- [ ] Linear 适配器 —— Linear 项目同步到多Agent协作
- [ ] GitHub Issues 双向同步
- **难度**：⭐⭐⭐
